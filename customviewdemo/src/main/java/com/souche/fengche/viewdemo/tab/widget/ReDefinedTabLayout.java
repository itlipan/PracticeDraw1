package com.souche.fengche.viewdemo.tab.widget;
...
public class ReDefinedTabLayout extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link ReDefinedTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link ReDefinedTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    public ReDefinedTabLayout(Context context) {
        this(context, null);
    }

    public ReDefinedTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ReDefinedTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ReDefinedTabLayout,
        ...
        mTabPaddingStart = mTabPaddingTop = mTabPaddingEnd = mTabPaddingBottom = a
            .getDimensionPixelSize(R.styleable.ReDefinedTabLayout_tabPadding, 0);
        mTabPaddingStart = a.getDimensionPixelSize(R.styleable.ReDefinedTabLayout_tabPaddingStart,
            mTabPaddingStart);
        mTabPaddingTop = a.getDimensionPixelSize(R.styleable.ReDefinedTabLayout_tabPaddingTop,
            mTabPaddingTop);
        mTabPaddingEnd = a.getDimensionPixelSize(R.styleable.ReDefinedTabLayout_tabPaddingEnd,
            mTabPaddingEnd);
        mTabPaddingBottom = a.getDimensionPixelSize(R.styleable.ReDefinedTabLayout_tabPaddingBottom,
            mTabPaddingBottom);

        mTabTextAppearance = a.getResourceId(R.styleable.ReDefinedTabLayout_tabTextAppearance,
        ...
        if (a.hasValue(R.styleable.ReDefinedTabLayout_tabTextColor)) {
            // If we have an explicit text color set, use it instead
            mTabTextColors = a.getColorStateList(R.styleable.ReDefinedTabLayout_tabTextColor);
        }

        if (a.hasValue(R.styleable.ReDefinedTabLayout_tabSelectedTextColor)) {
            // We have an explicit selected text color set, so we need to make merge it with the
            // current colors. This is exposed so that developers can use theme attributes to set
            // this (theme attrs in ColorStateLists are Lollipop+)
            final int selected = a.getColor(R.styleable.ReDefinedTabLayout_tabSelectedTextColor, 0);
            mTabTextColors = createColorStateList(mTabTextColors.getDefaultColor(), selected);
        }

        mRequestedTabMinWidth = a.getDimensionPixelSize(R.styleable.ReDefinedTabLayout_tabMinWidth,
            INVALID_WIDTH);
        mRequestedTabMaxWidth = a.getDimensionPixelSize(R.styleable.ReDefinedTabLayout_tabMaxWidth,
            INVALID_WIDTH);
        mTabBackgroundResId = a.getResourceId(R.styleable.ReDefinedTabLayout_tabBackground, 0);
        mContentInsetStart = a.getDimensionPixelSize(R.styleable.ReDefinedTabLayout_tabContentStart, 0);
        mMode = a.getInt(R.styleable.ReDefinedTabLayout_tabMode, MODE_FIXED);
        mTabGravity = a.getInt(R.styleable.ReDefinedTabLayout_tabGravity, GRAVITY_FILL);
        a.recycle();
    ...
    private void addTabFromItemView(@NonNull ReDefinedTabItem item) {
    ...
    /**
     * Add a {@link ReDefinedTabLayout.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     * <p>
    ...
    /**
     * Remove the given {@link ReDefinedTabLayout.OnTabSelectedListener} that was previously added via
    ...
    /**
     * Remove all previously added {@link ReDefinedTabLayout.OnTabSelectedListener}s.
     */
    ...
    /**
     * Returns the current mode used by this {@link ReDefinedTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    /**
     * The one-stop shop for setting up this {@link ReDefinedTabLayout} with a {@link ViewPager}.
     * <p>
     ...
     * necessary calls back to the provided {@link ReDefinedTabLayout} so that the tab position is
     * kept in sync.
     * <p>
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<ReDefinedTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(ReDefinedTabLayout tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final ReDefinedTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link ReDefinedTabLayout.OnTabSelectedListener} class which contains the necessary calls back
     * to the provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements ReDefinedTabLayout.OnTabSelectedListener {
        ...
        @Override
        public void onTabSelected(ReDefinedTabLayout.Tab tab) {
            mViewPager.setCurrentItem(tab.getPosition());
        }

        @Override
        public void onTabUnselected(ReDefinedTabLayout.Tab tab) {
            // No-op
        }

        @Override
        public void onTabReselected(ReDefinedTabLayout.Tab tab) {
            // No-op
        }
    }
    ...
    private static final class ThemeUtils {
    ...
    private static final class AnimationUtils {
